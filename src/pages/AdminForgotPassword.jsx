      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-2">Admin Forgot Password</h1>
            <p className="text-white/50">Reset your admin password with OTP</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8">
            ...
            {step === 1 && (
              <form onSubmit={handleSendOTP} className="space-y-6">
                <div>
                  <label className="block text-sm font-medium mb-2 text-white/70">Admin Email</label>
                  <input
                    type="email"
                    value={email}
          ...
          <p className="text-center mt-6 text-white/40 text-sm">
            <button onClick={() => navigate('/admin-login')} className="text-brand-orange hover:text-white transition-colors">Back to Admin Login</button>
          </p>
        </div>
      </div>
    </div>
